databaseChangeLog {
    changeSet(id: 't_user_aud', author: 'mudryi_roman') {
        createTable(tableName: 't_user_aud') {
        ...
        addPrimaryKey(columnNames: 'id,rev', constraintName: 'pk_user_aud', tableName: 't_user_aud')
    }
}